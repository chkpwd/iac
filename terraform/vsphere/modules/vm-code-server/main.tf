...
resource "vsphere_virtual_machine" "standalone" {
  ...
  provisioner "local-exec" {
    command = "ansible-playbook --private-key ${var.vm_public_key} -e 'pub_key=${var.vm_public_key}' /home/hyoga/code/boilerplates/ansible/playbooks/setup_code_server.yml"
  }
}
